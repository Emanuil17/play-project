...
var company = [ 'Apple', 'Microsoft', 'Nokia', 'VW'];
...
var productNameItemSelectedHandler = function(eventObject, suggestionObject, suggestionDataset) {
	  idTypeahead.val(suggestionObject.id);  
	  nameTypeahead.val(suggestionObject.name);
	  empNumTypeahead.val(suggestionObject.empNum);
	  emailTypeahead.val(suggestionObject.email);
...
idTypeahead.on('val', idItemSelectedHandler);
nameTypeahead.on('val', nameItemSelectedHandler);
empNumTypeahead.on('val', empNumItemSelectedHandler);
emailTypeahead.on('val', emailItemSelectedHandler);
productIDTypeahead.on('val', productIDItemSelectedHandler);
productNameTypeahead.on('val', productNameItemSelectedHandler);
productPriceTypeahead.on('val', productPriceItemSelectedHandler);
